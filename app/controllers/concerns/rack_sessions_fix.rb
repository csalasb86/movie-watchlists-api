...
# but devise relies on sessions to function. Before Rails 7, sessions were passed as a hash,
# so even if they were disabled, devise could still write into a session hash.
...
# If we try to use devise in this configuration we will get the error:
